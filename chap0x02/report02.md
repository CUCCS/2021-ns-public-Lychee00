...
- **思考题：**
    ...
    ***属于 BLP 模型**：对于刚接收的短信,所有客人用户（低安全等级）都可以对其查看，属于下读行为；可以回复短信，属于上写行为。*

    - 系统或第三方应用程序是否提供了上述功能的访问控制规则修改？如果修改默认配置，是提高了安全性还是降低了安全性？
    ***是**，但是第三方应用程序对安全性的影响依赖于用户的设置，如果设置不当就，安全性就会降低。*
## 课后思考题
...
## 参考文献
- [浅谈人脸识别的优缺点](http://www.qianjia.com/html/2017-10/12_277891.html)
- [探秘身份认证利器——声纹识别](https://www.cnblogs.com/alisecurity/p/6179233.html)
